<x-app-layout>
            ...
            <div class="flex flex-row justify-between items-center">
                <div class="flex flex-row gap-x-5 items-center stroke-white">
                    <svg width="50" height="50" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div>
                            <p class="text-slate-500 dark:text-gray-100 text-sm">Wallet Balance</p>
    ...
    <div class="py-12">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 dark:text-gray-100 overflow-hidden p-10 shadow-sm sm:rounded-lg">
                ...
                <form method="POST" action="{{ route('admin.projects.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="mt-4">
                        ...
                        <select name="category_id" id="category_id" class="py-3 rounded-lg pl-3 w-full dark:bg-gray-800">
                    ...
                    <div class="mt-4">
                        ...
                        <textarea name="about" id="about" cols="30" rows="5" class="dark:bg-gray-800 rounded-xl w-full"></textarea>
                    ...
                    <div class="mt-4">
                        ...
                        <select name="skill_level" id="skill_level" class="py-3 rounded-lg pl-3 w-full dark:bg-gray-800">
