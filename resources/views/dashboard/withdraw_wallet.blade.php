<x-app-layout>
    <x-slot name="header">
        <div class="flex flex-row justify-between items-center dark:bg-gray-800 ">
    ...
    <div class="py-12">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 dark:text-gray-100 overflow-hidden shadow-sm sm:rounded-lg p-10 flex flex-col gap-y-5">
                ...
                <div class="flex flex-row justify-between items-center">
                    <div class="flex flex-row gap-x-5 items-center stroke-lime-100 ">
                        <svg width="100" height="100" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div>
                                <p class="text-gray-100 text-sm">Total Balance</p>
                                <h3 class="text-gray-100 text-xl font-bold">Rp {{number_format(Auth::user()->wallet->balance, 0, ',','.')}}</h3>
                            </div>
                    </div>
                </div>
                <hr class="my-5">
                ...
                <h3 class="text-indigo-950 dark:text-gray-100 text-xl font-bold">Withdraw Money</h3>
