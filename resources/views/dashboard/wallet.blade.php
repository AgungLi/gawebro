<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:text-gray-100 dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-10 flex flex-col gap-y-5">
                <div class="flex flex-row justify-between items-center">
                    <div class="flex flex-row gap-x-5 items-center stroke-lime-100">
                        <svg width="100" height="100" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div>
                                <p class="text-slate-500 dark:text-gray-100 text-sm">Total Balance</p>
                                <h3 class="text-indigo-950 dark:text-gray-100 text-xl font-bold">Rp {{number_format(Auth::user()->wallet->balance, 0, ',','.')}}</h3>
                ...
                <hr class="my-5">
                <h3 class="text-indigo-950 dark:text-gray-100 text-xl font-bold">Latest Transactions</h3>

                @forelse ($wallet_transactions as $transaction)
                <div class="flex flex-row  justify-between items-center">
                    <div class="flex flex-row gap-x-5 stroke-lime-100">
                        <svg width="50" height="50" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div>
                                <p class="text-slate-500 dark:text-gray-100 text-sm">Total Amount</p>
                                <h3 class="text-indigo-950 dark:text-gray-100 text-xl font-bold">
                    ...
                    <div class="">
                        <p class="text-slate-500 text-sm dark:text-gray-100">Type</p>
                        <h3 class="text-indigo-950 text-xl font-bold dark:text-gray-100">{{ $transaction->type }}</h3>
                    </div>
                        ...
                        <div>
                            <p class="text-slate-500 text-sm dark:text-gray-100">Date</p>
                            <h3 class="text-indigo-950 text-xl font-bold dark:text-gray-100">{{ $transaction->created_at->format('M d, Y') }}</h3>
                        </div>
                </div>
                @empty
